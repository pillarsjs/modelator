...
const Modelator = module.exports.Modelator = function(config = {}){
  ...
  Modelator.prototype.do = function(action, data, input, cb, uid, keys){
    ...
    const path = [];
    const context = {modelator, action, data, input, uid, keys, owner, guest, fieldData, fieldInput, result, errors, path};

    // no devueleve errores
