...
function Driver(config){
  ...
  Driver.prototype.remove = function(transaction, pointer, sentence, main, done){
    ...
    for(const controllable of relations){
      ...
      reverseChain.add(driver.removeBack.bind(driver), transaction, controllable.id , parent, index);
    }
  ...
  Driver.prototype.removeBack = function(transaction, collection , relation, index, done){
    const driver = this;
